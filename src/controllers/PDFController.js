...
exports.pdf_cocina = async(req, res) => {
    ...
    conexion.query(SELECT_PRODUCT_ID, [id], async (error, results) => {
        ...
        // define table
        const tableData = [
            ['ID','Nombre','Descripción','Precio','Stock', 'Fecha'],
            ...products
        ];
        // console.log(products);
        // define positions
...
exports.pdf_ventas = async(req, res) => {
    ...
    conexion.query(SEARCH_SALE, [id], async (error, results) => {
        ...
        const creacion_fecha = results[0]['fecha'] !== undefined ? results[0]['fecha'] : new Date()
        ...
        // define table
        const tableData = [
            ['ID','Usuario','Cliente','Tipo de Cliente','Fecha', 'Voucher', 'Total'],
            ...sales
        ];
        // define positions
        const startX = 50;
